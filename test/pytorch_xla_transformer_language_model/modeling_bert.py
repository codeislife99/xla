...
from test.pytorch_xla_transformer_language_model.transformer import Layer
...
class BertModel(nn.Module):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        Layer(
            ...
            dropout=0.1) for i in range(config.num_hidden_layers)
        ]
    ...
    def forward(
        ...
        # LayerChange
        encoder_outputs = self.layers(embedding_output)
    ...
    def forward(
        ...
        if labels is not None:
            if self.num_labels == 1:
                ...
                loss = self.loss_fct(logits.view(-1, 256), labels.view(-1))
