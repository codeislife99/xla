...
def main(index):
  ...
  if xla_enabled:
    train_loader = get_dataloader('/pytorch/xla/test/pytorch-xla-transformer-language-model/datasets/enwik8/train/train.txt.raw',
                                  BATCH_SIZE, SEQUENCE_LENGTH, 0)    
  else:
    train_loader = get_dataloader('test/pytorch-xla-transformer-language-model/datasets/enwik8/train/train.txt.raw',
                                BATCH_SIZE, SEQUENCE_LENGTH, 0)
